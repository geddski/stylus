    ...
    for (var key in obj){
      ...
      if ('object' == typeof val) {
        ...
        if ('string' == val.nodeName){
          val = parseUnit(val.string) || parseColor(val.string) || new nodes.Literal(val.string);
        }
...
function parseColor(str){
  if(str.substr(0,1) === '#'){
    ...
    return new nodes.RGBA(r,g,b,1);
  }
  //TODO rgb and rgba
  //TODO color aliases like "blue"
  
  //color: #a27400; //dark
  // #ffca45 //light //255, 202, 69
  // val = new nodes.RGBA(255,202,69,1);
}